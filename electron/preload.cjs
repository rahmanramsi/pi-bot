...
contextBridge.exposeInMainWorld("piBot", {
  ...
  listComposerContext: () => ipcRenderer.invoke("pi:list-composer-context"),
  pickAttachments: (sessionId) => ipcRenderer.invoke("pi:pick-attachments", sessionId),
  stageAttachment: (input) => ipcRenderer.invoke("pi:stage-attachment", input),
  removeAttachment: (attachmentId, sessionId, cleanupToken) => ipcRenderer.invoke("pi:remove-attachment", attachmentId, sessionId, cleanupToken),
