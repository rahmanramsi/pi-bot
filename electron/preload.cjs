...
contextBridge.exposeInMainWorld("piBot", {
  ...
  listTeamChats: () => ipcRenderer.invoke("pi:list-team-chats"),
  createTeamChat: (name, agentIds, runLimit) => ipcRenderer.invoke("pi:create-team-chat", name, agentIds, runLimit),
  openTeamChat: (teamChatId) => ipcRenderer.invoke("pi:open-team-chat", teamChatId),
  renameTeamChat: (teamChatId, name) => ipcRenderer.invoke("pi:rename-team-chat", teamChatId, name),
  updateTeamMembers: (teamChatId, agentIds) => ipcRenderer.invoke("pi:update-team-members", teamChatId, agentIds),
  deleteTeamChat: (teamChatId) => ipcRenderer.invoke("pi:delete-team-chat", teamChatId),
  startTeamRun: (teamChatId, goal) => ipcRenderer.invoke("pi:start-team-run", teamChatId, goal),
  stopTeamRun: (teamChatId) => ipcRenderer.invoke("pi:stop-team-run", teamChatId),
  retryTeamRun: (teamChatId) => ipcRenderer.invoke("pi:retry-team-run", teamChatId),
  resumeTeamRun: (teamChatId, direction) => ipcRenderer.invoke("pi:resume-team-run", teamChatId, direction),
