...
contextBridge.exposeInMainWorld("piBot", {
  ...
  getMemories: (agentId) => ipcRenderer.invoke("pi:get-memories", agentId),
  createMemory: (agentId, content) => ipcRenderer.invoke("pi:create-memory", agentId, content),
  updateMemory: (agentId, memoryId, content) => ipcRenderer.invoke("pi:update-memory", agentId, memoryId, content),
  deleteMemory: (agentId, memoryId) => ipcRenderer.invoke("pi:delete-memory", agentId, memoryId),
