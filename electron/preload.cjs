...
contextBridge.exposeInMainWorld("piBot", {
  ...
  getBrowserTabPartition: (tabId, sessionKey) => ipcRenderer.invoke("pi:get-browser-tab-partition", tabId, sessionKey),
  registerBrowserTab: (tabId, sessionKey) => ipcRenderer.invoke("pi:browser-register-tab", tabId, sessionKey),
  unregisterBrowserTab: (tabId, sessionKey) => ipcRenderer.invoke("pi:browser-unregister-tab", tabId, sessionKey),
