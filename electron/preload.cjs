...
contextBridge.exposeInMainWorld("piBot", {
  ...
  openSession: (sessionPath, agentId, attentionId) => ipcRenderer.invoke("pi:open-session", sessionPath, agentId, attentionId),
  ...
  getAttention: () => ipcRenderer.invoke("pi:get-attention"),
  markAttentionRead: (id) => ipcRenderer.invoke("pi:mark-attention-read", id),
  resolveAttention: (id) => ipcRenderer.invoke("pi:resolve-attention", id),
  dismissAttention: (id) => ipcRenderer.invoke("pi:dismiss-attention", id),
